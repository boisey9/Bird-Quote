...
type LoginPageProps = {
  status: string;
  onSignIn: (email: string) => boolean | Promise<boolean>;
};
    ...
    <main className="loginShell">
      <section className="loginHeroPanel">
        ...
        <div className="loginFeatureGrid">
          ...
          <span><LockKeyhole size={18} /> Profile lookup ready</span>
        </div>
      </section>
      ...
      <section className="loginCard">
        <div className="loginCardHeader">
          ...
          <div>
            ...
            <span>Uses portal profiles first, seed profiles as fallback.</span>
          </div>
        </div>
        <form onSubmit={submit} className="loginForm">
          ...
          <button type="submit" className="primary loginButton" disabled={isSigningIn}>{isSigningIn ? 'Signing in...' : 'Sign In'} <ArrowRight size={18} /></button>
        </form>
        <div className="demoUserList">
          <strong>Seed profiles</strong>
